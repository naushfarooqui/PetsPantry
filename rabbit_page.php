...
// Fetch products in the "Rabbit Food" category
...
<html>
<head>
    <title>Rabbit Food Products</title>
...
<?php if ($result->num_rows > 0): ?>
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="product">
            ...
            <div class="product-info">
                ...
                <form action="rabbit_page.php" method="POST">
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p>No products found in the Rabbit Food category.</p>
<?php endif; ?>
</div>
