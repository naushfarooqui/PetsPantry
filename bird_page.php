...
// Fetch products in the "Bird Food" category
$category = 'bird_food';
...
<html>
<head>
    <title>Bird Food Products</title>
...
<?php if ($result->num_rows > 0): ?>
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="product">
            ...
            <div class="product-info">
                ...
                <form action="bird_page.php" method="POST" onsubmit="return checkLogin();">
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p>No products found in the Bird Food category.</p>
<?php endif; ?>
</div>
